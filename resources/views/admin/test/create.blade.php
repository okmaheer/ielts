                ...
                <div class="row g-9 mb-8">
                    <div class="col-md-6">
                        ...
                        <select class="form-control form-control-solid required" name="category">
                            ...
                            <option value="2">General Training</option>
                        </select>
                    </div>
                ...
                <div class="card mt-8 mb-8" style="border: 2px solid #e4e6ef;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-9 mb-4">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control form-control-solid" 
                                          ...
                                          rows="3"
                                          maxlength="170"
                                          placeholder="e.g., Solve IELTS listening test on junior cycle camp and check your band score with answers."></textarea>
                                <div class="form-text">
                        ...
                        <div class="alert alert-light border mb-6">
                            ...
                            <div class="google-preview p-3" style="background-color: #fff; border-radius: 5px;">
                                <div class="preview-title mb-1" style="color: #1a0dab; font-size: 18px; font-weight: 400; cursor: pointer;">
                                    <span id="listening-preview-title">Your Listening Test Title</span>
                                </div>
                                <div class="preview-url mb-1" style="color: #006621; font-size: 14px;">
                                    ieltsprepandpractice.com › listening › test › [id]
                                </div>
                                <div class="preview-description" style="color: #545454; font-size: 13px; line-height: 1.4;">
                                    <span id="listening-preview-description">Your listening meta description will appear here.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-9 mb-4">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control form-control-solid" 
                                          ...
                                          rows="3"
                                          maxlength="170"
                                          placeholder="e.g., Solve IELTS reading test on why pagodas fall down and check your band scores with answers."></textarea>
                                <div class="form-text">
                        ...
                        <div class="alert alert-light border">
                            ...
                            <div class="google-preview p-3" style="background-color: #fff; border-radius: 5px;">
                                <div class="preview-title mb-1" style="color: #1a0dab; font-size: 18px; font-weight: 400; cursor: pointer;">
                                    <span id="reading-preview-title">Your Reading Test Title</span>
                                </div>
                                <div class="preview-url mb-1" style="color: #006621; font-size: 14px;">
                                    ieltsprepandpractice.com › reading › test › [id]
                                </div>
                                <div class="preview-description" style="color: #545454; font-size: 13px; line-height: 1.4;">
                                    <span id="reading-preview-description">Your reading meta description will appear here.</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card mt-8 mb-8" style="border: 2px solid #e4e6ef;">
                    <div class="card-header" style="background-color: #f5f8fa;">
                        <h3 class="card-title">
                            ...
                            <small class="text-muted ms-2 fw-normal" style="font-size:13px;">/show/listening/test/{id} &amp; /show/reading/test/{id}</small>
                        </h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row g-9 mb-4">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control form-control-solid"
                                          ...
                                          rows="3"
                                          maxlength="170"
                                          placeholder="e.g., Read instructions and start Cambridge 16 Listening Test 3 on IPP."></textarea>
                            </div>
                        </div>
                        <div class="row g-9 mb-4">
                            <div class="col-md-12">
                        ...
                        <div class="row g-9 mb-4">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control form-control-solid"
                                          ...
                                          rows="3"
                                          maxlength="170"
                                          placeholder="e.g., Read instructions and start Cambridge 7 Academic Reading Test 1 on IPP."></textarea>
                            </div>
                        </div>
                        <div class="row g-9 mb-4">
                            <div class="col-md-12">
                        ...
                        <div class="row g-9 mb-4">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control form-control-solid"
                                          ...
                                          rows="3"
                                          maxlength="170"
                                          placeholder="e.g., View your score and correct answers for Cambridge 16 Listening Test 3."></textarea>
                            </div>
                        </div>
                        <div class="row g-9 mb-4">
                            <div class="col-md-12">
                        ...
                        <div class="row g-9 mb-4">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control form-control-solid"
                                          ...
                                          rows="3"
                                          maxlength="170"
                                          placeholder="e.g., View your score and correct answers for Cambridge 7 Academic Reading Test 1."></textarea>
                            </div>
                        </div>
                        <div class="row g-9 mb-4">
                            <div class="col-md-12">
